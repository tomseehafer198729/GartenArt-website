//#region node_modules/.nitro/vite/services/ssr/assets/projects-OAl-TWgB.js
var PROJECTS = [
	{
		...
		summary: "Beete neu gefasst mit Kleinsteinpflaster. Die Rasenfläche wurde abgetragen und durch einen Teppich aus Sandthymian ersetzt — trittfest, blühend, pflegearm.",
		tags: [
			"Kleinsteinpflaster",
			"Sandthymian",
			"200 m²"
	...
	},
	{
		...
		summary: "Pflanzbeet durch ein Hochbeet ersetzt. Neuer Weg aus Wegplatten mit Randeinfassung. Terrasse barrierefrei, dazu eine Treppe — gebaut, damit Senioren den Garten ohne Schwelle nutzen können.",
		tags: [
			"Hochbeet",
			"Wegplatten",
	...
	},
	{
		...
		summary: "Ausgehoben, Randeinfassung gesetzt, Fundament betoniert. Darauf ein Biohort-Gartenhaus — standfest, eben, fertig zum Nutzen.",
		tags: [
			"Aushub",
			"Randeinfassung",
			"Fundament",
	...
	},
	{
		...
		summary: "Alte Rasenfläche abgetragen, Boden gefräst, planiert und gedüngt. Anschließend Rollrasen verlegt — sofort dicht, gleichmäßig, begehbar.",
		tags: [
			"Abtrag",
			"Fräsen",
			"Planum",
	...
	},
	{
		...
		summary: "Rasennarbe abgezogen, Sträucher eingekürzt. Pflanzsteine geöffnet, darin Lavendel gesetzt, die Steine mit Flusskies 8/16 verfüllt.",
		tags: [
			"Lavendel",
			"Pflanzsteine",
			"Flusskies 8/16"
	...
	},
	{
		...
		summary: "Alte Fläche aufgenommen, neue Betonplatten verlegt. Die Terrasse sitzt eben und schwellenfrei am Haus — barrierefrei, trittfest, ohne Stufe.",
		tags: [
			"Betonplatten",
			"Barrierefrei",
			"Terrasse"
