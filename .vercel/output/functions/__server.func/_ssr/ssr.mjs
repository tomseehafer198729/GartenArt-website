...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Du1pTCX9.mjs");
...
var manifest = { "12f38ad81766a6107e49f15d41e5b59577313a5f2792dd12480f97e731a996ce": {
	functionName: "submitInquiry_createServerFn_handler",
	importer: () => import("./contact-Cpm31ePt.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-vI6J447R.mjs").then((n) => n.t),
