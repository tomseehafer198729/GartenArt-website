...
**This app is GartenArt & BauProjekte.** Before any visual, copy, nav, logo or
page change, open **`.grok/skills/gartenart-brand/SKILL.md`**. It overrides
`design-ui` where they conflict (palette, 2 px radius, no shadows, Spectral +
Inter, no generic GaLaBau).
